...
public static class Data
{
    ...
    public static readonly float[] _rotationMatrix = new float[] { cos, sin, -sin, cos };

    public static readonly Dictionary<Tetromino, Vector2Int[]> _cells = new Dictionary<Tetromino, Vector2Int[]>()
    {
    ...
    public static readonly Dictionary<Tetromino, Vector2Int[,]> _wallKicks = new Dictionary<Tetromino, Vector2Int[,]>()
    {
        { Tetromino.I, _wallKicksI },
        { Tetromino.J, _wallKicksJLOSTZ },
        { Tetromino.L, _wallKicksJLOSTZ },
        { Tetromino.O, _wallKicksJLOSTZ },
        { Tetromino.S, _wallKicksJLOSTZ },
        { Tetromino.T, _wallKicksJLOSTZ },
        { Tetromino.Z, _wallKicksJLOSTZ },
    };
